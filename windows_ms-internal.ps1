...
Invoke-WebRequest "Invoke-WebRequest "https://merrimac-elastic.s3.us-east-2.amazonaws.com/beats_modified_uncompressed.zip" -OutFile "C:\temp\modified_uncompressed.zip"
